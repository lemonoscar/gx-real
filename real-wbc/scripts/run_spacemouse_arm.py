...
def parse_args():
    ...
    parser.add_argument("--model", default="X5_umi")
    ...
    parser.add_argument("--sm-tx-axis", choices=["x", "y", "z"], default="x")
    parser.add_argument("--sm-ty-axis", choices=["x", "y", "z"], default="y")
    parser.add_argument("--sm-tz-axis", choices=["x", "y", "z"], default="z")
